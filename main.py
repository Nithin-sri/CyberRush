...
def main():
    ...
    while True:
        ...
        for event in pygame.event.get():
            ...
            # ── Results ──
                ...
                if action == "play_again":
                    # Replay whatever mode just finished. Quiz mode reuses
                    # the QuizScreen instance via reset(); arcade mode uses
                    # GameScreen.set_mode().
                    if game_mode == "quiz":
                        quiz.reset()
                        state = "quiz"
            ...
            # ── Quiz ──
                ...
                if quiz.done():
                    results.set_result(quiz.score, "quiz",
                                       quiz.best_combo, quiz.encountered)
                    state = "results"
        ...
        elif state == "quiz":        quiz.update(dt)
        ...
        elif state == "quiz":        quiz.draw(window)
